...
const finnpowerProductsData = [
  {
    ...
    link: "/stanok-rvd/pages/products/finnpower/p16hp_p20hp/",
    specs: [
  ...
  },
  {
    ...
    link: "/stanok-rvd/pages/products/finnpower/press_p20hp/",
    specs: [
      { label: "Тип:", value: "Радиальный пресс" },
      { label: "Назначение:", value: "Ремонт шлангов" },
    ],
  },
  {
    ...
    link: "/stanok-rvd/pages/products/finnpower/p21ms_p32x/",
    specs: [
      { label: "Тип:", value: "Радиальный пресс" },
  ...
  },
  {
    ...
    link: "/stanok-rvd/pages/products/finnpower/p20nms/",
    specs: [
      { label: "Тип:", value: "Радиальный пресс" },
      { label: "Назначение:", value: "Ремонт шлангов" },
    ],
  },
  {
    ...
    link: "/stanok-rvd/pages/products/finnpower/20ms_32ms/",
    specs: [
      { label: "Тип:", value: "Радиальный пресс" },
      { label: "Назначение:", value: "Ремонт шлангов" },
    ],
  },
  {
    ...
    link: "/stanok-rvd/pages/products/finnpower/press_p32x/",
    specs: [
      { label: "Тип:", value: "Радиальный пресс" },
      { label: "Назначение:", value: "Производство РВД" },
    ],
  },
  {
    ...
    link: "/stanok-rvd/pages/products/finnpower/p32nms/",
    specs: [
      { label: "Тип:", value: "Радиальный пресс" },
      { label: "Назначение:", value: "Ремонт шлангов" },
    ],
  },
  {
    ...
    link: "/stanok-rvd/pages/products/finnpower/press_p32ms/",
    specs: [
      { label: "Тип:", value: "Радиальный пресс" },
      { label: "Назначение:", value: "Ремонт шлангов" },
    ],
  },
  {
    ...
    link: "/stanok-rvd/pages/products/finnpower/51uc/",
    specs: [
      { label: "Тип:", value: "Радиальный пресс" },
  ...
  },
  {
    ...
    link: "/stanok-rvd/pages/products/finnpower/p60uc/",
    specs: [
      { label: "Тип:", value: "Радиальный пресс" },
  ...
  },
  {
    ...
    link: "/stanok-rvd/pages/products/finnpower/fp20_fp120/",
    specs: [
  ...
  },
  {
    ...
    image: "https://stanok-rvd.ru/stanki_rvd/finnpower/120uc_small.jpg",
    link: "/stanok-rvd/pages/products/finnpower/fp120/",
    specs: [
      { label: "Тип:", value: "Пресс серийный" },
      { label: "Назначение:", value: "Сервис шлангов" },
    ],
